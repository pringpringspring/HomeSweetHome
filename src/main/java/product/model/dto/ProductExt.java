...
public class ProductExt extends Product {
	...
	public String toString() {
		return "ProductExt [productImgCount=" + productImgCount + ", productImages=" + productImages
				+ ", productDescriptionImages=" + productDescriptionImages + ", todayDeals=" + todayDeals
				+ ", brandName=" + brandName + ", mainCategoryName=" + mainCategoryName + ", subCategoryName="
				+ subCategoryName + ", getProductId()=" + getProductId() + ", getProductName()=" + getProductName()
				+ ", getMainCode()=" + getMainCode() + ", getSubCode()=" + getSubCode() + ", getBrandId()="
				+ getBrandId() + ", getProductHeight()=" + getProductHeight() + ", getProductWidth()="
				+ getProductWidth() + ", getProductDepth()=" + getProductDepth() + ", getProductColor()="
				+ getProductColor() + ", getProductPrice()=" + getProductPrice() + ", getRegDate()=" + getRegDate()
				+ ", getPContent()=" + getPContent() + ", toString()=" + super.toString() + ", getClass()=" + getClass()
				+ ", hashCode()=" + hashCode() + "]";
	}
