...
<footer>
	<div class="footer-container">
		<address class="layout-footer-cs">
			<div class="layout-footer-cs-row">
				<a class="layout-footer-cs-link" href="/customerCenter/main">고객센터</a>
			</div>
			<div class="cs-tel-wrapper">
				<a class="cs-tel-wrapper" href="tel:1111-1111">1111-1111</a>
			</div>
			<span class="cs-timetable">평일 09:00 ~ 18:00 (주말 &amp; 공휴일 제외)</span>
		</address>
		<p class="layout-footer-copyright">Copyright 2022. PK_LAST_NAME
					...
					<div class="layout-footer__top">
						<address class="layout-footer__cs">
							<div class="layout-footer__cs__row">
								<a class="layout-footer__cs__link" href="/customer_center">고객센터
							...
							<div class="cs-tel-wrapper">
								<a class="cs-tel-wrapper" href="tel:1670-0876">1588-1234</a>
							</div>
							<span class="cs-timetable">평일 09:00 ~ 18:00 (주말
								&amp; 공휴일 제외)</span>
						</address>
						<div class="layout-footer__outbound">
							<a class="layout-footer__outbound__item"
								...
								rel="noreferrer noopener" title="네이버 블로그" aria-label="네이버 블로그"><svg
								 ...
								 </svg></a><a class="layout-footer__outbound__item"
					...
					<address class="layout-footer__info-wrap">
						<dl class="layout-footer__info">
							...
							<span class="layout-footer__info__item"><dt>이메일</dt>
								<dd>
									(고객문의)<a href="mailto:cs@bucketplace.net">
										cs@bucketplace.net </a>(제휴문의)<a
										href="mailto:contact@bucketplace.net">
							...
							<span class="layout-footer__info__item"><dt>사업자등록번호</dt>
								<dd>000-00-00000</dd></span>
							<span class="layout-footer__info__item"><dt>통신판매업신고번호</dt>
								<dd>
									제2022-서울강남-0001호<b
										class="layout-footer__info__item__check-link">&nbsp;사업자정보확인</b>
								</dd></span>
						</dl>
						<dl class="layout-footer__info">
						...
						<span class="layout-footer__info"><span
							class="layout-footer__info__item">(주)버킷플레이스는 통신판매중개자로 거래
								당사자가 아니므로, 판매자가 등록한 상품정보 및 거래 등에 대해 책임을 지지 않습니다<br>단,
								㈜버킷플레이스가 판매자로 등록 판매한 상품은 판매자로서 책임을 부담합니다
						</span></span>
					</address>
					<p class="layout-footer__copyright">Copyright 2014.
						bucketplace, Co., Ltd. All rights reserved</p>
					<div class="css-v1pw39 e1q59vf03">
						<div class="css-9fythf e1q59vf02">
							<img
								src="https://assets.ohou.se/web/dist/media/assets/icons/mark_isms-1751469ae3fb2e9b51fe7fbe6210449d.png"
								alt="ISMS 정보보호 관리체계 인증" width="32" height="32"
								class="css-68x97p e1q59vf00">
							<div class="css-gqy9zz e1q59vf01">
								오늘의집 서비스 운영
								
								<br>2021. 09. 08 ~ 2024. 09. 07
							</div>
						</div>
						<div class="css-9fythf e1q59vf02">
							<img
								src="https://assets.ohou.se/web/dist/media/assets/icons/mark_iso27001-f73b550bba54864a1ddc382ed3223667.png"
								alt="ISO/IEC 27001 인증" width="32" height="32"
								class="css-68x97p e1q59vf00">
						</div>
					</div>
				</div>
